    ...
    return (
        <div className='image-zoom-div'>
            <div className='btn-div'>
                <button onClick={()=>{handleZoomIn()}}><span>add</span></button>
                <button onClick={()=>{handleZoomOut()}}><span>remove</span></button>
            </div>
            <img ref={imageRef} src={imageUrl} alt="" className='zoom-img' draggable={false}  
